...
# changed a few things, including introducing padding
...
class CharCNN():
    ...
    def __init__(self, num_classes=2, filter_widths=(7, 7, 3, 3, 3, 3),
                 num_filters_per_layer=(100, 200, 300, 400, 500, 600), l2_reg_lambda=0.0,
                 seq_max_length=140, char_voc_size=70):
        ...
        # todo: stddev should depend on small/large model 0.02/0.05
        # Q: why do we add b in relu? is this normal?
